...
class Courrier(models.Model):
    emetteur = models.CharField(max_length=150, choices=EMETTEUR)
    ...
    def __str__(self):
        return f'{self.transmetteur} ------ ({self.code})'
...
class Scan(models.Model):
    ...
    courrier = models.OneToOneField(
        Courrier,
        to_field='code',              # uses Courrier.code instead of pk
    ...
    def __str__(self):
        return f"{self.name} ({self.courrier.code})"